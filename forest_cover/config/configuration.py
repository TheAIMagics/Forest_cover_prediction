...
from forest_cover.entity.config_entity import DataIngestionConfig, DataTransformationConfig,DataValidationConfig,   \
ModelTrainerConfig,ModelEvaluationConfig,ModelPusherConfig,TrainingPipelineConfig
from forest_cover.util.util import read_yaml_file
...
class Configuartion:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            zip_download_dir = os.path.join(ROOT_DIR,'covtype.zip')
